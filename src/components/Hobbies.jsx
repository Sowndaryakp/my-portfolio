      ...
      <div className="p-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
          ...
          <div className={`border border-gray-300 rounded-lg shadow-lg relative w-full p-6 md:p-8 transition-shadow duration-300 ease-in-out hover:shadow-2xl ${cardClasses}`}>
            ...
            <div className="mb-4">
              <img src={rubiksCubeImage} alt="Rubik's Cube" className="w-full h-80 object-cover mb-2 rounded-lg" />
            </div>
          ...
          <div className={`border border-gray-300 rounded-lg shadow-lg relative w-full p-6 md:p-8 transition-shadow duration-300 ease-in-out hover:shadow-2xl ${cardClasses}`}>
            ...
            <div className="mb-4">
              <img src={booksImage} alt="Reading Books" className="w-full h-70 object-cover mb-2 rounded-lg" />
            </div>
            <p className={`${descriptionClasses} mb-2`}>
          ...
          <div className={`border border-gray-300 rounded-lg shadow-lg relative w-full p-6 md:p-8 transition-shadow duration-300 ease-in-out hover:shadow-2xl ${cardClasses}`}>
            ...
            <div className="mb-4">
              <img src={musicImage} alt="Listening to Songs" className="w-full h-80 object-cover mb-2 rounded-lg" />
            </div>
            <p className={`${descriptionClasses} mb-2`}>
          ...
          <div className={`border border-gray-300 rounded-lg shadow-lg relative w-full p-6 md:p-8 transition-shadow duration-300 ease-in-out hover:shadow-2xl ${cardClasses}`}>
            ...
            <div className="mb-4">
              <img src={travelImage} alt="Traveling" className="w-full h-80 object-cover mb-2 rounded-lg" />
            </div>
            <p className={`${descriptionClasses} mb-2`}>
