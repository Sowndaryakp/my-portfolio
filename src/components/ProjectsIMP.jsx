...
const projects = [
  {
    ...
    details: `
      ...
      Develop a personal portfolio website for Sowndarya K P, showcasing her skills, projects, and contact information. The website will be built using React.js for frontend development, Tailwind CSS for styling, and integrated with EmailJS for contact form submissions.<br /><br />

      <strong>Technical Skills:</strong><br />
      <ul>
        <li>Proficiency in React.js for building dynamic and interactive web applications.</li>
        <li>Experience in utilizing Tailwind CSS for responsive and visually appealing UI design.</li>
        <li>Knowledge of EmailJS for handling contact form submissions and sending emails.</li>
        <li>Understanding of frontend routing for navigation between different sections of the portfolio website.</li>
        <li>Ability to integrate external APIs and services for enhanced functionality and user experience.</li>
      ...
      <ul>
        ...
        <li>Integrating React.js components to showcase skills, projects, and other relevant information effectively.</li>
        <li>Implementing a contact form with EmailJS integration for enabling users to reach out to Sowndarya K P.</li>
      ...
      <ul>
        ...
        <li>Gaining insights into user behavior and preferences through analytics and user feedback to continually improve the portfolio website.</li>
        </ul>
    `,
  },
  {
